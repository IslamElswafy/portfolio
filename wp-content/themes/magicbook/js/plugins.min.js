! function(e, t, i) {
    ...
    function r(t, i) {
        i !== Object(i) && (i = {}), this.cache = {}, this.el = t, this.value = function(t) {
            var n;
            return void 0 === this.cache[t] && (void 0 !== (n = e(this.el).attr("data-cbox-" + t)) ? this.cache[t] = n : void 0 !== i[t] ? this.cache[t] = i[t] : void 0 !== V[t] && (this.cache[t] = V[t])), this.cache[t]
        }, this.get = function(t) {
            var i = this.value(t);
    ...
    function a(e, t) {
        return Math.round((/%/.test(e) ? ("x" === t ? L.width() : o()) / 100 : 1) * parseInt(e, 10))
    }
    ...
    function u(e) {
        u.str !== e && (w.add(b).removeClass(u.str).addClass(e), u.str = e)
    }

    function h(t) {
        B = 0, t && !1 !== t && "nofollow" !== t ? (k = e("." + ee).filter(function() {
            return new r(this, e.data(this, J)).get("rel") === t
        }), -1 === (B = k.index(D.el)) && (k = k.add(D.el), B = k.length - 1)) : k = e(D.el)
    }
    ...
    function f(i) {
        var o;
        if (!U) {
            if (o = e(i).data(J), D = new r(i, o), h(D.get("rel")), !$) {
                $ = F = !0, u(D.get("className")), w.css({
                    visibility: "hidden",
                    display: "block",
                    opacity: ""
                }), W = n(le, "LoadedContent", "width:0; height:0; overflow:hidden; visibility:hidden"), x.css({
                    width: "",
                    height: ""
                }).append(W), O = S.height() + E.height() + x.outerHeight(!0) - x.height(), j = T.width() + C.width() + x.outerWidth(!0) - x.width(), q = W.outerHeight(!0), _ = W.outerWidth(!0);
                var s = a(D.get("initialWidth"), "x"),
                    l = a(D.get("initialHeight"), "y"),
                    c = D.get("maxWidth"),
                    f = D.get("maxHeight");
                D.w = Math.max((!1 !== c ? Math.min(s, a(c, "x")) : s) - _ - j, 0), D.h = Math.max((!1 !== f ? Math.min(l, a(f, "y")) : l) - q - O, 0), W.css({
                    width: "",
                    height: D.h
                }), Q.position(), p(te), D.get("onOpen"), X.add(P).hide(), w.focus(), D.get("trapFocus") && t.addEventListener && (t.addEventListener("focus", d, !0), ae.one(re, function() {
                    t.removeEventListener("focus", d, !0)
                })), D.get("returnFocus") && ae.one(re, function() {
                    e(D.el).focus()
                })
            }
            var v = parseFloat(D.get("opacity"));
            b.css({
                opacity: v === v ? v : "",
                cursor: D.get("overlayClose") ? "pointer" : "",
                visibility: "visible"
            }).show(), D.get("closeButton") ? R.html(D.get("close")).appendTo(x) : R.appendTo("<div/>"), g()
        }
    }

    function v() {
        w || (G = !1, L = e(i), w = n(le).attr({
            id: J,
            class: !1 === e.support.opacity ? Z + "IE" : "",
            role: "dialog",
            tabindex: "-1"
        }).hide(), b = n(le, "Overlay").hide(), M = e([n(le, "LoadingOverlay")[0], n(le, "LoadingGraphic")[0]]), y = n(le, "Wrapper"), x = n(le, "Content").append(P = n(le, "Title"), A = n(le, "Current"), H = e('<button type="button"/>').attr({
            id: Z + "Previous"
        }), N = e('<button type="button"/>').attr({
            id: Z + "Next"
        }), Y = e('<button type="button"/>').attr({
            id: Z + "Slideshow"
        }), M), R = e('<button type="button"/>').attr({
            id: Z + "Close"
        }), y.append(n(le).append(n(le, "TopLeft"), S = n(le, "TopCenter"), n(le, "TopRight")), n(le, !1, "clear:left").append(T = n(le, "MiddleLeft"), x, C = n(le, "MiddleRight")), n(le, !1, "clear:left").append(n(le, "BottomLeft"), E = n(le, "BottomCenter"), n(le, "BottomRight"))).find("div div").css({
            float: "left"
        }), I = n(le, !1, "position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"), X = N.add(H).add(A).add(Y)), t.body && !w.parent().length && e(t.body).append(b, w.append(y, I))
    }
    ...
    function m() {
        ...
        return !!w && (G || (G = !0, N.click(function() {
            Q.next()
        }), H.click(function() {
            Q.prev()
        }), R.click(function() {
            ...
            D.get("overlayClose") && Q.close()
        }), e(t).bind("keydown." + Z, function(e) {
            var t = e.keyCode;
            $ && D.get("escKey") && 27 === t && (e.preventDefault(), Q.close()), $ && D.get("arrowKey") && k[1] && !e.altKey && (37 === t ? (e.preventDefault(), H.click()) : 39 === t && (e.preventDefault(), N.click()))
        }), e.isFunction(e.fn.on) ? e(t).on("click." + Z, "." + ee, i) : e("." + ee).live("click." + Z, i)), !0)
    }

    function g() {
        var t, o, r, s = Q.prep,
            d = ++ce;
        if (F = !0, z = !1, p(se), p(ie), D.get("onLoad"), D.h = D.get("height") ? a(D.get("height"), "y") - q - O : D.get("innerHeight") && a(D.get("innerHeight"), "y"), D.w = D.get("width") ? a(D.get("width"), "x") - _ - j : D.get("innerWidth") && a(D.get("innerWidth"), "x"), D.mw = D.w, D.mh = D.h, D.get("maxWidth") && (D.mw = a(D.get("maxWidth"), "x") - _ - j, D.mw = D.w && D.w < D.mw ? D.w : D.mw), D.get("maxHeight") && (D.mh = a(D.get("maxHeight"), "y") - q - O, D.mh = D.h && D.h < D.mh ? D.h : D.mh), t = D.get("href"), K = setTimeout(function() {
                M.show()
            }, 100), D.get("inline")) {
            var u = e(t).eq(0);
            r = e("<div>").hide().insertBefore(u), ae.one(se, function() {
                r.replaceWith(u)
            }), s(u)
        } else D.get("iframe") ? s(" ") : D.get("html") ? s(D.get("html")) : l(D, t) ? (t = c(D, t), z = D.get("createImg"), e(z).addClass(Z + "Photo").bind("error." + Z, function() {
            s(n(le, "Error").html(D.get("imgError")))
        }).one("load", function() {
            d === ce && setTimeout(function() {
                var t;
                D.get("retinaImage") && i.devicePixelRatio > 1 && (z.height = z.height / i.devicePixelRatio, z.width = z.width / i.devicePixelRatio), D.get("scalePhotos") && (o = function() {
                    z.height -= z.height * t, z.width -= z.width * t
                }, D.mw && z.width > D.mw && (t = (z.width - D.mw) / z.width, o()), D.mh && z.height > D.mh && (t = (z.height - D.mh) / z.height, o())), D.h && (z.style.marginTop = Math.max(D.mh - z.height, 0) / 2 + "px"), k[1] && (D.get("loop") || k[B + 1]) && (z.style.cursor = "pointer", e(z).bind("click." + Z, function() {
                    Q.next()
                })), z.style.width = z.width + "px", z.style.height = z.height + "px", s(z)
            }, 1)
        }), z.src = t) : t && I.load(t, D.get("data"), function(t, i) {
            d === ce && s("error" === i ? n(le, "Error").html(D.get("xhrError")) : e(this).contents())
        })
    }
    var b, w, y, x, S, T, C, E, k, L, W, I, M, P, A, Y, N, H, R, X, D, O, j, q, _, B, z, $, F, U, K, Q, G, V = {
            html: !1,
            photo: !1,
            iframe: !1,
            inline: !1,
        ...
        ue = function() {
            ...
            function t() {
                (D.get("loop") || k[B + 1]) && (e(), s = setTimeout(Q.next, D.get("slideshowSpeed")))
            }

            function i() {
                Y.html(D.get("slideshowStop")).unbind(l).one(l, n), ae.bind(ne, t).bind(ie, e), w.removeClass(a + "off").addClass(a + "on")
            }

            function n() {
                e(), ae.unbind(ne, t).unbind(ie, e), Y.html(D.get("slideshowStart")).unbind(l).one(l, function() {
                    Q.next(), i()
                }), w.removeClass(a + "on").addClass(a + "off")
            }

            function o() {
                r = !1, Y.hide(), e(), ae.unbind(ne, t).unbind(ie, e), w.removeClass(a + "off " + a + "on")
            }
            var r, s, a = Z + "Slideshow_",
                l = "click." + Z;
            return function() {
                r ? D.get("slideshow") || (ae.unbind(oe, o), o()) : D.get("slideshow") && k[1] && (r = !0, ae.one(oe, o), D.get("slideshowAuto") ? i() : n(), Y.show())
            }
        }();
    e[J] || (e(v), (Q = e.fn[J] = e[J] = function(t, i) {
        var n = this;
        return t = t || {}, e.isFunction(n) && (n = e("<a/>"), t.open = !0), n[0] ? (v(), m() && (i && (t.onComplete = i), n.each(function() {
            var i = e.data(this, J) || {};
            e.data(this, J, e.extend(i, t))
        }).addClass(ee), new r(n[0], t).get("open") && f(n[0])), n) : n
    }).position = function(t, i) {
        function n() {
            S[0].style.width = E[0].style.width = x[0].style.width = parseInt(w[0].style.width, 10) - j + "px", x[0].style.height = T[0].style.height = C[0].style.height = parseInt(w[0].style.height, 10) - O + "px"
        }
        var r, s, l, c = 0,
            d = 0,
            u = w.offset();
        if (L.unbind("resize." + Z), w.css({
                top: -9e4,
                left: -9e4
            }), s = L.scrollTop(), l = L.scrollLeft(), D.get("fixed") ? (u.top -= s, u.left -= l, w.css({
                position: "fixed"
            })) : (c = s, d = l, w.css({
                position: "absolute"
            })), !1 !== D.get("right") ? d += Math.max(L.width() - D.w - _ - j - a(D.get("right"), "x"), 0) : !1 !== D.get("left") ? d += a(D.get("left"), "x") : d += Math.round(Math.max(L.width() - D.w - _ - j, 0) / 2), !1 !== D.get("bottom") ? c += Math.max(o() - D.h - q - O - a(D.get("bottom"), "y"), 0) : !1 !== D.get("top") ? c += a(D.get("top"), "y") : c += Math.round(Math.max(o() - D.h - q - O, 0) / 2), w.css({
                top: u.top,
                left: u.left,
                visibility: "visible"
        ...
        de = r, t || w.css(r), w.dequeue().animate(r, {
            duration: t || 0,
            complete: function() {
                n(), F = !1, y[0].style.width = D.w + _ + j + "px", y[0].style.height = D.h + q + O + "px", D.get("reposition") && setTimeout(function() {
                    L.bind("resize." + Z, Q.position)
                }, 1), e.isFunction(i) && i()
            },
            step: n
        })
        ...
        var t;
        $ && ((e = e || {}).width && (D.w = a(e.width, "x") - _ - j), e.innerWidth && (D.w = a(e.innerWidth, "x")), W.css({
            width: D.w
        }), e.height && (D.h = a(e.height, "y") - q - O), e.innerHeight && (D.h = a(e.innerHeight, "y")), e.innerHeight || e.height || (t = W.scrollTop(), W.css({
            height: "auto"
        }), D.h = W.height()), W.css({
            height: D.h
        }), t && W.scrollTop(t), Q.position("none" === D.get("transition") ? 0 : D.get("speed")))
    }, Q.prep = function(i) {
        if ($) {
            var o, a = "none" === D.get("transition") ? 0 : D.get("speed");
            W.remove(), (W = n(le, "LoadedContent").append(i)).hide().appendTo(I.show()).css({
                width: function() {
                ...
                var n, o, d = k.length;
                $ && (o = function() {
                    clearTimeout(K), M.hide(), p(ne), D.get("onComplete")
                }, P.html(D.get("title")).show(), W.show(), d > 1 ? ("string" == typeof D.get("current") && A.html(D.get("current").replace("{current}", B + 1).replace("{total}", d)).show(), N[D.get("loop") || B < d - 1 ? "show" : "hide"]().html(D.get("next")), H[D.get("loop") || B ? "show" : "hide"]().html(D.get("previous")), ue(), D.get("preloading") && e.each([s(-1), s(1)], function() {
                    var i = k[this],
                        n = new r(i, e.data(i, J)),
                        o = n.get("href");
                    o && l(n, o) && (o = c(n, o), t.createElement("img").src = o)
                })) : X.hide(), D.get("iframe") ? (n = D.get("createIframe"), D.get("scrolling") || (n.scrolling = "no"), e(n).attr({
                    src: D.get("href"),
                    class: Z + "Iframe"
                }).one("load", o).appendTo(W), ae.one(se, function() {
                    n.src = "//about:blank"
                }), D.get("fastIframe") && e(n).trigger("load")) : o(), "fade" === D.get("transition") ? w.fadeTo(a, 1, i) : i())
            }, "fade" === D.get("transition") ? w.fadeTo(a, 0, function() {
                Q.position(0, o)
            }) : Q.position(a, o)
        }
    }, Q.next = function() {
        !F && k[1] && (D.get("loop") || k[B + 1]) && (B = s(1), f(k[B]))
    }, Q.prev = function() {
        !F && k[1] && (D.get("loop") || B) && (B = s(-1), f(k[B]))
    }, Q.close = function() {
        $ && !U && (U = !0, $ = !1, p(oe), D.get("onCleanup"), L.unbind("." + Z), b.fadeTo(D.get("fadeOut") || 0, 0), w.stop().fadeTo(D.get("fadeOut") || 0, 0, function() {
            w.hide(), b.hide(), p(se), W.remove(), setTimeout(function() {
                U = !1, p(re), D.get("onClosed")
            }, 1)
        }))
    }, Q.remove = function() {
        w && (w.stop(), e[J].close(), w.stop(!1, !0).remove(), b.remove(), U = !1, w = null, e("." + ee).removeData(J).removeClass(ee), e(t).unbind("click." + Z).unbind("keydown." + Z))
    }, Q.element = function() {
        return e(D.el)
    }, Q.settings = V)
...
function() {
    ...
    function(e, t) {
        ...
        s.prototype = new t, s.prototype.options = {}, s.prototype.getImages = function() {
            ...
            function e(e, o) {
                return t.options.debug && u && d.log("confirm", e, o), t.progress(e), ++i === n && t.complete(), !0
            }
            var t = this,
                i = 0,
    ...
    function(e) {
        ...
        e.fn.bjqs = function(t) {
            var i = {
                ...
                b = function() {
                    m.width = o.outerWidth(), m.ratio = m.width / n.width, m.height = n.height * m.ratio, "fade" === n.animtype && (s.css({
                        height: n.height,
                        width: "100%"
                    }), s.children("img").css({
                        height: n.height,
                        ...
                        m.width = o.outerWidth(), m.ratio = m.width / n.width, m.height = n.height * m.ratio, s.css({
                            height: m.height
                        }), s.children("img").css({
                            height: m.height
                        }), r.css({
                ...
                x = function() {
                    p = s.eq(0).clone(), f = s.eq(v.slidecount - 1).clone(), p.attr({
                        "data-clone": "last",
                        "data-slide": 0
                    }).appendTo(r).show(), f.attr({
                        "data-clone": "first",
                        "data-slide": 0
                    }).prependTo(r).show(), s = r.children("li"), v.slidecount = s.length, h = e('<div class="bjqs-wrapper"></div>'), n.responsive && m.width < n.width ? (h.css({
                        width: m.width,
                        height: m.height,
                        overflow: "hidden",
                        position: "relative"
                        ...
                        width: n.width * (v.slidecount + 2),
                        left: -n.width * v.currentslide
                    })), s.css({
                        float: "left",
                        position: "relative",
                        display: "list-item"
                    }), h.prependTo(o), r.appendTo(h)
                },
                S = function() {
                    if (a = e('<ul class="bjqs-controls"></ul>'), l = e('<li class="bjqs-next"><a href="#" data-direction="' + g.fwd + '">' + n.nexttext + "</a></li>"), c = e('<li class="bjqs-prev"><a href="#" data-direction="' + g.prev + '">' + n.prevtext + "</a></li>"), a.on("click", "a", function(t) {
                            t.preventDefault();
                            var i = e(this).attr("data-direction");
                            v.animating || (i === g.fwd && I(g.fwd, !1), i === g.prev && I(g.prev, !1))
                        }), c.appendTo(a), l.appendTo(a), a.appendTo(o), n.centercontrols) {
                        a.addClass("v-centered");
                        var t = (o.height() - l.children("a").outerHeight()) / 2 / n.height * 100 + "%";
                        l.find("a").css("top", t), c.find("a").css("top", t)
                    }
                },
                T = function() {
                    if (d = e('<ol class="bjqs-markers"></ol>'), e.each(s, function(t, i) {
                            var o = t + 1,
                                r = t + 1;
                            "slide" === n.animtype && (r = t + 2);
                            var s = e('<li><a href="#">' + o + "</a></li>");
                            o === v.currentslide && s.addClass("active-marker"), s.on("click", "a", function(e) {
                                e.preventDefault(), v.animating || v.currentslide === r || I(!1, r)
                            }), s.appendTo(d)
                        }), d.appendTo(o), u = d.find("li"), n.centermarkers) {
                        d.addClass("h-centered");
                        var t = (n.width - d.width()) / 2;
                        d.css("left", t)
                    }
                },
                C = function() {
                    e(document).keyup(function(e) {
                        v.paused || (clearInterval(v.interval), v.paused = !0), v.animating || (39 === e.keyCode ? (e.preventDefault(), I(g.fwd, !1)) : 37 === e.keyCode && (e.preventDefault(), I(g.prev, !1))), v.paused && n.automatic && (v.interval = setInterval(function() {
                            I(g.fwd)
                        }, n.animspeed), v.paused = !1)
                    })
                },
                E = function() {
                    o.hover(function() {
                ...
                W = function(e) {
                    e === g.fwd ? s.eq(v.currentindex).next().length ? (v.nextindex = v.currentindex + 1, v.nextslide = v.currentslide + 1) : (v.nextindex = 0, v.nextslide = 1) : s.eq(v.currentindex).prev().length ? (v.nextindex = v.currentindex - 1, v.nextslide = v.currentslide - 1) : (v.nextindex = v.slidecount - 1, v.nextslide = v.slidecount)
                },
                I = function(e, t) {
                    if (!v.animating && (v.animating = !0, t ? (v.nextslide = t, v.nextindex = t - 1) : W(e), "fade" === n.animtype && (n.showmarkers && (u.removeClass("active-marker"), u.eq(v.nextindex).addClass("active-marker")), s.eq(v.currentindex).fadeOut(n.animduration), s.eq(v.nextindex).fadeIn(n.animduration, function() {
                            v.animating = !1, v.currentslide = v.nextslide, v.currentindex = v.nextindex
                        })), "slide" === n.animtype)) {
                        if (n.showmarkers) {
                            var i = v.nextindex - 1;
                            i === v.slidecount - 2 ? i = 0 : -1 === i && (i = v.slidecount - 3), u.removeClass("active-marker"), u.eq(i).addClass("active-marker")
                        }
                        n.responsive && m.width < n.width ? v.slidewidth = m.width : v.slidewidth = n.width, r.animate({
                            left: -v.nextindex * v.slidewidth
                        }, n.animduration, function() {
                            v.currentslide = v.nextslide, v.currentindex = v.nextindex, "last" === s.eq(v.currentindex).attr("data-clone") ? (r.css({
                                left: -v.slidewidth
                            }), v.currentslide = 2, v.currentindex = 1) : "first" === s.eq(v.currentindex).attr("data-clone") && (r.css({
    ...
    function(e) {
        var t = jQuery.event,
            i = function(e, t, i, n) {
                ...
                for (o = 0; o < t.length; o++)
                    for ((a = (r = t[o]).indexOf(".") < 0) || (r = (d = r.split(".")).shift(), u = new RegExp("(^|\\.)" + d.slice(0).sort().join("\\.(?:.*\\.)?") + "(\\.|$)")), s = (e[r] || []).slice(0), l = 0; l < s.length; l++) c = s[l], (a || u.test(c.namespace)) && (n ? c.selector === n && i(r, c.origHandler || c.handler) : null === n ? i(r, c.origHandler || c.handler, c.selector) : c.selector || i(r, c.origHandler || c.handler))
            };
        t.find = function(t, n, o) {
            var r = (e._data(t) || {}).events,
                s = [];
            return r ? (i(r, n, function(e, t) {
                s.push(t)
            }, o), s) : s
        }, t.findBySelector = function(t, n) {
            var o = e._data(t).events,
                r = {},
                s = function(e, t, i) {
                    var n = r[e] || (r[e] = {});
                    (n[t] || (n[t] = [])).push(i)
                };
            return o ? (i(o, n, function(e, t, i) {
                s(i || "", e, t)
            }, null), r) : r
        ...
        }, t.setupHelper = function(i, n, o) {
            o || (o = n, n = null);
            var r = function(r) {
                    var s = r.selector || "";
                    s ? t.find(this, i, s).length || e(this).delegate(s, n, o) : t.find(this, i, s).length || t.add(this, n, o, {
                        selector: s,
                        delegate: this
                    })
                },
                s = function(r) {
                    var s = r.selector || "";
                    s ? t.find(this, i, s).length || e(this).undelegate(s, n, o) : t.find(this, i, s).length || t.remove(this, n, o, {
                        selector: s,
                        delegate: this
                    })
                };
    ...
    function(e) {
        ...
        e.event.setupHelper(["swipe", "swipeleft", "swiperight", "swipeup", "swipedown"], i, function(t) {
            function i(e) {
                l && (a = r(e), Math.abs(l.coords[0] - a.coords[0]) > 10 && e.preventDefault())
            }
            var a, l = r(t),
                c = t.delegateTarget || t.currentTarget,
                d = t.handleObj.selector,
                u = this;
            e(document.documentElement).bind(o, i).one(n, function(n) {
                if (e(this).unbind(o, i), l && a) {
                    var r = Math.abs(l.coords[0] - a.coords[0]),
                        h = Math.abs(l.coords[1] - a.coords[1]),
                        p = Math.sqrt(r * r + h * h);
                    if (a.time - l.time < s.delay && p >= s.min) {
                        var f = ["swipe"];
                        r >= s.min && h < s.min ? f.push(l.coords[0] > a.coords[0] ? "swipeleft" : "swiperight") : h >= s.min && r < s.min && f.push(l.coords[1] < a.coords[1] ? "swipedown" : "swipeup"), e.each(e.event.find(c, f, d), function() {
                            this.call(u, t, {
                                start: l,
                                end: a
                            })
    ...
    function e(t, i, n) {
                ...
                e.fn.perfectScrollbar = function(t) {
                    return this.each(function() {
                        if ("object" == typeof t || void 0 === t) {
                            var i = t;
                            r.get(this) || o.initialize(this, i)
                        } else {
                            var n = t;
        ...
        9: [function(e, t, i) {
            ...
            t.exports = function(e) {
                var t = r.get(e);
                t && (t.event.unbindAll(), n.remove(t.scrollbarX), n.remove(t.scrollbarY), n.remove(t.scrollbarXRail), n.remove(t.scrollbarYRail), o.removePsClasses(e), r.remove(e))
            }
        }, {
            "../lib/dom": 3,
            "../lib/helper": 6,
        ...
        10: [function(e, t, i) {
            ...
            function n(e, t) {
                ...
                t.settings.stopPropagationOnClick && t.event.bind(t.scrollbarY, "click", n), t.event.bind(t.scrollbarYRail, "click", function(n) {
                    var r = o.toInt(t.scrollbarYHeight / 2),
                        a = t.railYRatio * (n.pageY - window.scrollY - i(t.scrollbarYRail).top - r) / (t.railYRatio * (t.railYHeight - t.scrollbarYHeight));
                    a < 0 ? a = 0 : a > 1 && (a = 1), e.scrollTop = (t.contentHeight - t.containerHeight) * a, s(e), n.stopPropagation()
                }), t.settings.stopPropagationOnClick && t.event.bind(t.scrollbarX, "click", n), t.event.bind(t.scrollbarXRail, "click", function(n) {
                    var r = o.toInt(t.scrollbarXWidth / 2),
                        a = t.railXRatio * (n.pageX - window.scrollX - i(t.scrollbarXRail).left - r) / (t.railXRatio * (t.railXWidth - t.scrollbarXWidth));
                    a < 0 ? a = 0 : a > 1 && (a = 1), e.scrollLeft = (t.contentWidth - t.containerWidth) * a - t.negativeScrollAdjustment, s(e), n.stopPropagation()
                })
            }
            var o = e("../../lib/helper"),
                r = e("../instances"),
            ...
            function n(e, t) {
                function i(i) {
                    var o = n + i * t.railXRatio,
                        r = t.scrollbarXRail.getBoundingClientRect().left + t.railXRatio * (t.railXWidth - t.scrollbarXWidth);
                ...
                t.event.bind(t.scrollbarX, "mousedown", function(i) {
                    o = i.pageX, n = s.toInt(r.css(t.scrollbarX, "left")) * t.railXRatio, s.startScrolling(e, "x"), t.event.bind(t.ownerDocument, "mousemove", a), t.event.once(t.ownerDocument, "mouseup", c), i.stopPropagation(), i.preventDefault()
                })
            }
            ...
            function o(e, t) {
                function i(i) {
                    var o = n + i * t.railYRatio,
                        r = t.scrollbarYRail.getBoundingClientRect().top + t.railYRatio * (t.railYHeight - t.scrollbarYHeight);
                ...
                t.event.bind(t.scrollbarY, "mousedown", function(i) {
                    o = i.pageY, n = s.toInt(r.css(t.scrollbarY, "top")) * t.railYRatio, s.startScrolling(e, "y"), t.event.bind(t.ownerDocument, "mousemove", a), t.event.once(t.ownerDocument, "mouseup", c), i.stopPropagation(), i.preventDefault()
                })
            }
            var r = e("../../lib/dom"),
                s = e("../../lib/helper"),
                    ...
                    if ((!a.isDefaultPrevented || !a.isDefaultPrevented()) && n) {
                        ...
                        switch (a.which) {
                            ...
                            case 34:
                                ...
                                break;
                            case 35:
                                d = a.ctrlKey ? -t.contentHeight : -t.containerHeight;
                                break;
                            case 36:
                                d = a.ctrlKey ? e.scrollTop : t.containerHeight;
                                break;
                            default:
                                return
                        }
                        e.scrollTop = e.scrollTop - d, e.scrollLeft = e.scrollLeft + c, s(e), (r = i(c, d)) && a.preventDefault()
                    }
                })
            }
            var o = e("../../lib/helper"),
        ...
        13: [function(e, t, i) {
            ...
            function n(e, t) {
                ...
                function n(e) {
                    var t = e.deltaX,
                        i = -1 * e.deltaY;
                    return void 0 !== t && void 0 !== i || (t = -1 * e.wheelDeltaX / 6, i = e.wheelDeltaY / 6), e.deltaMode && 1 === e.deltaMode && (t *= 10, i *= 10), t !== t && i !== i && (t = 0, i = e.wheelDelta), [t, i]
                }
            ...
            function n(e, t) {
                ...
                function n() {
                    l || (l = setInterval(function() {
                        r.get(e) ? (e.scrollTop = e.scrollTop + c.top, e.scrollLeft = e.scrollLeft + c.left, s(e)) : clearInterval(l)
                    }, 50))
                }
                ...
                t.event.bind(t.ownerDocument, "selectionchange", function() {
                    ...
                    if (d) {
                        ...
                        i.x < r.left + 3 ? (c.left = -5, o.startScrolling(e, "x")) : i.x > r.right - 3 ? (c.left = 5, o.startScrolling(e, "x")) : c.left = 0, i.y < r.top + 3 ? (c.top = r.top + 3 - i.y < 5 ? -5 : -20, o.startScrolling(e, "y")) : i.y > r.bottom - 3 ? (c.top = i.y - r.bottom + 3 < 5 ? 5 : 20, o.startScrolling(e, "y")) : c.top = 0, 0 === c.top && 0 === c.left ? a() : n()
                    }
                })
            }
            var o = e("../../lib/helper"),
        ...
        16: [function(e, t, i) {
            ...
            function n(e, t, i, n) {
                function s(i, n) {
                    ...
                    } else if (s > a && (i < 0 && r === t.contentWidth - t.containerWidth || i > 0 && 0 === r)) return !t.settings.swipePropagation;
                    return !0
                }

                function a(t, i) {
                    e.scrollTop = e.scrollTop - i, e.scrollLeft = e.scrollLeft - t, r(e)
                }
                ...
                function h(e) {
                    if (u(e)) {
                        y = !0;
                        var t = d(e);
                        v.pageX = t.pageX, v.pageY = t.pageY, m = (new Date).getTime(), null !== b && clearInterval(b), e.stopPropagation()
                    }
                }
                ...
                function p(e) {
                    if (!w && y && u(e)) {
                        ...
                        var r = (new Date).getTime(),
                            l = r - m;
                        l > 0 && (g.x = n / l, g.y = o / l, m = r), s(n, o) && (e.stopPropagation(), e.preventDefault())
                    }
                }

                function f() {
                    !w && y && (y = !1, clearInterval(b), b = setInterval(function() {
                        o.get(e) ? Math.abs(g.x) < .01 && Math.abs(g.y) < .01 ? clearInterval(b) : (a(30 * g.x, 30 * g.y), g.x *= .8, g.y *= .8) : clearInterval(b)
                    }, 10))
                }
                var v = {},
                    m = 0,
                    ...
                    w = !1,
                    y = !1;
                i && (t.event.bind(window, "touchstart", l), t.event.bind(window, "touchend", c), t.event.bind(e, "touchstart", h), t.event.bind(e, "touchmove", p), t.event.bind(e, "touchend", f)), n && (window.PointerEvent ? (t.event.bind(window, "pointerdown", l), t.event.bind(window, "pointerup", c), t.event.bind(e, "pointerdown", h), t.event.bind(e, "pointermove", p), t.event.bind(e, "pointerup", f)) : window.MSPointerEvent && (t.event.bind(window, "MSPointerDown", l), t.event.bind(window, "MSPointerUp", c), t.event.bind(e, "MSPointerDown", h), t.event.bind(e, "MSPointerMove", p), t.event.bind(e, "MSPointerUp", f)))
            }
            var o = e("../instances"),
                r = e("../update-geometry");
        ...
        17: [function(e, t, i) {
            ...
            t.exports = function(e, t) {
                ...
                var i = r.add(e);
                i.settings = o.extend(i.settings, t), a(e), l(e), d(e), u(e), h(e), (o.env.supportsTouch || o.env.supportsIePointer) && p(e, o.env.supportsTouch, o.env.supportsIePointer), i.settings.useKeyboard && c(e), s(e)
            }
        }, {
            "../lib/class": 2,
            "../lib/helper": 6,
        ...
        18: [function(e, t, i) {
            ...
            function n(e) {
                var t = this;
                t.settings = u.clone(l), t.containerWidth = null, t.containerHeight = null, t.contentWidth = null, t.contentHeight = null, t.isRtl = "rtl" === a.css(e, "direction"), t.isNegativeScroll = function() {
                    var t = e.scrollLeft,
                        i = null;
        ...
        19: [function(e, t, i) {
            ...
            t.exports = function(e) {
                ...
                var i;
                e.contains(t.scrollbarXRail) || ((i = s.queryChildren(e, ".ps-scrollbar-x-rail")).length > 0 && i.forEach(function(e) {
                    s.remove(e)
                }), s.appendTo(t.scrollbarXRail, e)), e.contains(t.scrollbarYRail) || ((i = s.queryChildren(e, ".ps-scrollbar-y-rail")).length > 0 && i.forEach(function(e) {
                    s.remove(e)
    ...
    function(e, t, i) {
        ...
        o.addTest("csstransformspreserve3d", function() {
            var e, i = o.prefixed("transformStyle"),
                n = "preserve-3d";
            return !!i && (i = i.replace(/([A-Z])/g, function(e, t) {
                return "-" + t.toLowerCase()
            }).replace(/^ms-/, "-ms-"), o.testStyles("#modernizr{" + i + ":" + n + ";}", function(n, o) {
                e = t.getComputedStyle ? getComputedStyle(n, null).getPropertyValue(i) : ""
            }), e === n)
        });
        var r, s, a = e.event;
        r = a.special.debouncedresize = {
            ...
            handler: function(e, t) {
                var i = this,
                    n = arguments,
                    o = function() {
                        e.type = "debouncedresize", a.dispatch.apply(i, n)
                    };
                s && clearTimeout(s), t ? o() : s = setTimeout(o, r.threshold)
            },
            threshold: 150
        }, e.BookBlock = function(t, i) {
            this.$el = e(i), this._init(t)
        }, e.BookBlock.defaults = {
            startPage: 1,
            ...
            autoplay: !1,
            interval: 3e3,
            onEndFlip: function(e, t, i) {
                return !1
            },
            onBeforeFlip: function(e) {
                return !1
            }
        }, e.BookBlock.prototype = {
            _init: function(i) {
                ...
                this.transEndEventName = n[o.prefixed("transition")] + ".bookblock", this.support = o.csstransitions && o.csstransforms3d && o.csstransformspreserve3d && e(t).width() > 769, this._initEvents(), this.options.autoplay && (this.options.circular = !0, this._startSlideshow())
            },
            _initEvents: function() {
                var t = this;
                "" !== this.options.nextEl && e(this.options.nextEl).on("click.bookblock touchstart.bookblock", function() {
                    return t._action("next"), !1
                }), "" !== this.options.prevEl && e(this.options.prevEl).on("click.bookblock touchstart.bookblock", function() {
            ...
            _action: function(e, t) {
                this._stopSlideshow(), this._navigate(e, t)
            },
            _navigate: function(e, t) {
                if (this.isAnimating) return !1;
                this.options.onBeforeFlip(this.current), this.isAnimating = !0, this.$current = this.$items.eq(this.current), void 0 !== t ? this.current = t : "next" === e && "ltr" === this.options.direction || "prev" === e && "rtl" === this.options.direction ? this.options.circular || this.current !== this.itemsCount - 1 ? (this.previous = this.current, this.current = this.current < this.itemsCount - 1 ? this.current + 1 : 0) : this.end = !0 : ("prev" === e && "ltr" === this.options.direction || "next" === e && "rtl" === this.options.direction) && (this.options.circular || 0 !== this.current ? (this.previous = this.current, this.current = this.current > 0 ? this.current - 1 : this.itemsCount - 1) : this.end = !0), this.$nextItem = !this.options.circular && this.end ? this.$current : this.$items.eq(this.current), this.support ? this._layout(e) : this._layoutNoSupport(e)
            },
            _layoutNoSupport: function(e) {
                this.$items.fadeOut(300), this.$nextItem.fadeIn(300), this.end = !1, this.isAnimating = !1;
                var t = "next" === e && this.current === this.itemsCount - 1 || "prev" === e && 0 === this.current;
                this.options.onEndFlip(this.previous, this.current, t)
            },
            _layout: function(t) {
                var i = this,
                    n = this._addSide("left", t),
                    o = this._addSide("middle", t),
                    r = this._addSide("right", t),
                    s = n.find("div.bb-overlay"),
                    a = o.find("div.bb-flipoverlay:first"),
                    l = o.find("div.bb-flipoverlay:last"),
                    c = r.find("div.bb-overlay"),
                    d = this.end ? 400 : this.options.speed;
                if (this.$items.hide(), this.$el.prepend(n, o, r), o.css({
                        transitionDuration: d + "ms",
                        transitionTimingFunction: this.options.easing
                    }).on(this.transEndEventName, function(n) {
                        if (e(n.target).hasClass("bb-page")) {
                            i.$el.children(".bb-page").remove(), i.$nextItem.show(), i.end = !1, i.isAnimating = !1;
                            var o = "next" === t && i.current === i.itemsCount - 1 || "prev" === t && 0 === i.current;
                            i.options.onEndFlip(i.previous, i.current, o)
                        }
                    }), "prev" === t && o.addClass("bb-flip-initial"), this.options.shadows && !this.end) {
                    var u = "next" === t ? {
                    ...
                    a.css(h), l.css(p), s.css(u), c.css(f)
                }
                setTimeout(function() {
                    o.addClass(i.end ? "bb-flip-" + t + "-end" : "bb-flip-" + t), i.options.shadows && !i.end && (a.css({
                        opacity: "next" === t ? i.options.shadowFlip : 0
                    }), l.css({
                        opacity: "next" === t ? 0 : i.options.shadowFlip
                    }), s.css({
                        opacity: "next" === t ? i.options.shadowSides : 0
                    }), c.css({
                        opacity: "next" === t ? 0 : i.options.shadowSides
                    }))
                }, 100)
            },
            _addSide: function(t, i) {
                var n;
                switch (t) {
                    case "left":
                        n = e('<div class="bb-page"><div class="bb-back"><div class="bb-outer"><div class="bb-content"><div class="bb-inner">' + ("next" === i ? this.$current.html() : this.$nextItem.html()) + '</div></div><div class="bb-overlay"></div></div></div></div>').css("z-index", 102);
                        break;
                    case "middle":
                        n = e('<div class="bb-page"><div class="bb-front"><div class="bb-outer"><div class="bb-content"><div class="bb-inner">' + ("next" === i ? this.$current.html() : this.$nextItem.html()) + '</div></div><div class="bb-flipoverlay"></div></div></div><div class="bb-back"><div class="bb-outer"><div class="bb-content" style="width:' + this.elWidth + 'px"><div class="bb-inner">' + ("next" === i ? this.$nextItem.html() : this.$current.html()) + '</div></div><div class="bb-flipoverlay"></div></div></div></div>').css("z-index", 103);
                        break;
                    case "right":
                        n = e('<div class="bb-page"><div class="bb-front"><div class="bb-outer"><div class="bb-content"><div class="bb-inner">' + ("next" === i ? this.$nextItem.html() : this.$current.html()) + '</div></div><div class="bb-overlay"></div></div></div></div>').css("z-index", 101)
                }
                return n
            },
            _startSlideshow: function() {
                ...
                this.slideshow = setTimeout(function() {
                    e._navigate("next"), e.options.autoplay && e._startSlideshow()
            ...
            jump: function(e) {
                if ((e -= 1) === this.current || e >= this.itemsCount || e < 0) return !1;
                var t;
                t = "ltr" === this.options.direction ? e > this.current ? "next" : "prev" : e > this.current ? "prev" : "next", this._action(t, e)
            },
            last: function() {
            ...
            update: function() {
                ...
                this.$items = this.$el.children(".bb-item"), this.itemsCount = this.$items.length, this.current = e.index()
            },
            destroy: function() {
                this.options.autoplay && this._stopSlideshow(), this.$el.removeClass("bb-" + this.options.orientation), this.$items.show(), "" !== this.options.nextEl && e(this.options.nextEl).off(".bookblock"), "" !== this.options.prevEl && e(this.options.prevEl).off(".bookblock"), n.off("debouncedresize")
            }
        };
        var l = function(e) {
            t.console && t.console.error(e)
        };
        e.fn.bookblock = function(t) {
            if ("string" == typeof t) {
                var i = Array.prototype.slice.call(arguments, 1);
                this.each(function() {
                    var n = e.data(this, "bookblock");
                    n ? e.isFunction(n[t]) && "_" !== t.charAt(0) ? n[t].apply(n, i) : l("no such method '" + t + "' for bookblock instance") : l("cannot call methods on bookblock prior to initialization; attempted to call method '" + t + "'")
                })
            } else this.each(function() {
                var i = e.data(this, "bookblock");
                i ? i._init() : i = e.data(this, "bookblock", new e.BookBlock(t, this))
            });
            return this
        }
    }(jQuery, window),
    ...
    function(e) {
        ...
        function t(t) {
            var s = t || window.event,
                ...
                u = 0,
                h = 0;
            if (t = e.event.fix(s), t.type = "mousewheel", "detail" in s && (u = -1 * s.detail), "wheelDelta" in s && (u = s.wheelDelta), "wheelDeltaY" in s && (u = s.wheelDeltaY), "wheelDeltaX" in s && (d = -1 * s.wheelDeltaX), "axis" in s && s.axis === s.HORIZONTAL_AXIS && (d = -1 * u, u = 0), c = 0 === u ? d : u, "deltaY" in s && (c = u = -1 * s.deltaY), "deltaX" in s && (d = s.deltaX, 0 === u && (c = -1 * d)), 0 !== u || 0 !== d) {
                if (1 === s.deltaMode) {
        ...
        e.flexslider = function(i, n) {
            ...
            e.data(i, "flexslider", o), m = {
                init: function() {
                    ...
                    }), o.vars.pauseInvisible && m.pauseInvisible.isHidden() || (o.vars.initDelay > 0 ? o.startTimeout = setTimeout(o.play, o.vars.initDelay) : o.play())), v && m.asNav.setup(), l && o.vars.touch && m.touch(), (!f || f && o.vars.smoothHeight) && e(window).bind("resize orientationchange focus", m.resize), o.find("img").attr("draggable", "false"), setTimeout(function() {
                        o.vars.start(o)
                    }, 200)
                },
                asNav: {
                    setup: function() {
                        o.asNav = !0, o.animatingTo = Math.floor(o.currentSlide / o.move), o.currentItem = o.currentSlide, o.slides.removeClass(s + "active-slide").eq(o.currentItem).addClass(s + "active-slide"), a ? (i._slider = o, o.slides.each(function() {
                            ...
                            var i = e(this),
                                n = i.index();
                            0 >= i.offset().left - e(o).scrollLeft() && i.hasClass(s + "active-slide") ? o.flexAnimate(o.getTarget("prev"), !0) : e(o.vars.asNavFor).data("flexslider").animating || i.hasClass(s + "active-slide") || (o.direction = o.currentItem < n ? "next" : "prev", o.flexAnimate(n, o.vars.pauseOnAction, !1, !0, !0))
                        })
                    }
                },
                controlNav: {
                    ...
                    setupPaging: function() {
                        var t, i, n = "thumbnails" === o.vars.controlNav ? "control-thumbs" : "control-paging",
                            r = 1;
                        if (o.controlNavScaffold = e('<ol class="' + s + "control-nav " + s + n + '"></ol>'), o.pagingCount > 1)
                            for (var a = 0; a < o.pagingCount; a++) {
                                ...
                                if (t = "thumbnails" === o.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"' + l + "/>" : '<a href="#">' + r + "</a>", "thumbnails" === o.vars.controlNav && !0 === o.vars.thumbCaptions) {
                ...
                directionNav: {
                    setup: function() {
                        ...
                        o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (e(o.controlsContainer).append(t), o.directionNav = e("." + s + "direction-nav li a", o.controlsContainer)) : (o.append(t), o.directionNav = e("." + s + "direction-nav li a", o)), m.directionNav.update(), o.directionNav.bind(c, function(t) {
                            t.preventDefault();
                            var i;
                            "" !== d && d !== t.type || (i = e(this).hasClass(s + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(i, o.vars.pauseOnAction)), "" === d && (d = t.type), m.setToClearWatchedEvent()
                        })
                    },
                    update: function() {
                        var e = s + "disabled";
                ...
                pausePlay: {
                    setup: function() {
                        ...
                        o.controlsContainer ? (o.controlsContainer.append(t), o.pausePlay = e("." + s + "pauseplay a", o.controlsContainer)) : (o.append(t), o.pausePlay = e("." + s + "pauseplay a", o)), m.pausePlay.update(o.vars.slideshow ? s + "pause" : s + "play"), o.pausePlay.bind(c, function(t) {
                            t.preventDefault(), "" !== d && d !== t.type || (e(this).hasClass(s + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())), "" === d && (d = t.type), m.setToClearWatchedEvent()
                        })
                    },
                    update: function(e) {
                ...
                touch: function() {
                    function e(e) {
                        e.stopPropagation(), o.animating ? e.preventDefault() : (o.pause(), i._gesture.addPointer(e.pointerId), S = 0, c = u ? o.h : o.w, v = Number(new Date), l = p && h && o.animatingTo === o.last ? 0 : p && h ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : p && o.currentSlide === o.last ? o.limit : p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : h ? (o.last - o.currentSlide + o.cloneOffset) * c : (o.currentSlide + o.cloneOffset) * c)
                    }
                    ...
                    function t(e) {
                        ...
                        if (t) {
                            ...
                            return S += u ? o : n, d = S, w = u ? Math.abs(S) < Math.abs(-n) : Math.abs(S) < Math.abs(-o), e.detail === e.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                                i._gesture.stop()
                            }) : void((!w || Number(new Date) - v > 500) && (e.preventDefault(), !f && t.transitions && (t.vars.animationLoop || (d = S / (0 === t.currentSlide && 0 > S || t.currentSlide === t.last && S > 0 ? Math.abs(S) / c + 2 : 1)), t.setProps(l + d, "setTouch"))))
                        }
                    }
                    ...
                    function n(e) {
                        ...
                        if (t) {
                            if (t.animatingTo === t.currentSlide && !w && null !== d) {
                                ...
                                t.canAdvance(n) && (Number(new Date) - v < 550 && Math.abs(i) > 50 || Math.abs(i) > c / 2) ? t.flexAnimate(n, t.vars.pauseOnAction) : f || t.flexAnimate(t.currentSlide, t.vars.pauseOnAction, !0)
                            }
                            r = null, s = null, d = null, l = null, S = 0
                        }
                    }
                    var r, s, l, c, d, v, m, g, b, w = !1,
                        y = 0,
                        x = 0,
                        S = 0;
                    a ? (i.style.msTouchAction = "none", i._gesture = new MSGesture, i._gesture.target = i, i.addEventListener("MSPointerDown", e, !1), i._slider = o, i.addEventListener("MSGestureChange", t, !1), i.addEventListener("MSGestureEnd", n, !1)) : (m = function(e) {
                        ...
                        y = e.touches[0].pageX, x = e.touches[0].pageY, d = u ? r - x : r - y;
                        (!(w = u ? Math.abs(d) < Math.abs(y - s) : Math.abs(d) < Math.abs(x - s)) || Number(new Date) - v > 500) && (e.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (d /= 0 === o.currentSlide && 0 > d || o.currentSlide === o.last && d > 0 ? Math.abs(d) / c + 2 : 1), o.setProps(l + d, "setTouch")))
                    }, b = function(e) {
                        if (i.removeEventListener("touchmove", g, !1), o.animatingTo === o.currentSlide && !w && null !== d) {
                            var t = h ? -d : d,
                                n = t > 0 ? o.getTarget("next") : o.getTarget("prev");
                            o.canAdvance(n) && (Number(new Date) - v < 550 && Math.abs(t) > 50 || Math.abs(t) > c / 2) ? o.flexAnimate(n, o.vars.pauseOnAction) : f || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                        }
                        i.removeEventListener("touchend", b, !1), r = null, s = null, d = null, l = null
            ...
            }, o.flexAnimate = function(t, i, n, r, a) {
                if (o.vars.animationLoop || t === o.currentSlide || (o.direction = t > o.currentSlide ? "next" : "prev"), v && 1 === o.pagingCount && (o.direction = o.currentItem < t ? "next" : "prev"), !o.animating && (o.canAdvance(t, a) || n) && o.is(":visible")) {
                    if (v && r) {
                        var c = e(o.vars.asNavFor).data("flexslider");
                        if (o.atEnd = 0 === t || t === o.count - 1, c.flexAnimate(t, !0, !1, !0, a), o.direction = o.currentItem < t ? "next" : "prev", c.direction = o.direction, Math.ceil((t + 1) / o.visible) - 1 === o.currentSlide || 0 === t) return o.currentItem = t, o.slides.removeClass(s + "active-slide").eq(t).addClass(s + "active-slide"), !1;
                    ...
                    if (o.animating = !0, o.animatingTo = t, i && o.pause(), o.vars.before(o), o.syncExists && !a && m.sync("animate"), o.vars.controlNav && m.controlNav.active(), p || o.slides.removeClass(s + "active-slide").eq(t).addClass(s + "active-slide"), o.atEnd = 0 === t || t === o.last, o.vars.directionNav && m.directionNav.update(), t === o.last && (o.vars.end(o), o.vars.animationLoop || o.pause()), f) l ? (o.slides.eq(o.currentSlide).css({
                        ...
                        var d, g, b, w = u ? o.slides.filter(":first").height() : o.computedW;
                ...
                return !!t || (!(!v || o.currentItem !== o.count - 1 || 0 !== e || "prev" !== o.direction) || (!v || 0 !== o.currentItem || e !== o.pagingCount - 1 || "next" === o.direction) && (!(e === o.currentSlide && !v) && (!!o.vars.animationLoop || (!o.atEnd || 0 !== o.currentSlide || e !== i || "next" === o.direction) && (!o.atEnd || o.currentSlide !== i || 0 !== e || "next" !== o.direction))))
    ...
    function(e, t, i) {
        ...
        function o(e, t) {
            ...
            if (n.value == o.attr("placeholder") && o.hasClass("placeholder"))
                if (o.data("placeholder-password")) {
                    ...
                    o.focus()
                } else n.value = "", o.removeClass("placeholder"), n == s() && n.select()
        }
        ...
        d && u ? (l = h.placeholder = function() {
            ...
            set: function(e, t) {
                ...
                return a ? a[0].value = t : n.data("placeholder-enabled") ? ("" == t ? (e.value = t, e != s() && r.call(e)) : n.hasClass("placeholder") ? o.call(e, !0, t) || (e.value = t) : e.value = t, n) : e.value = t
            }
        }, d || (p.input = a, f.value = a), u || (p.textarea = a, f.value = a), i(function() {
